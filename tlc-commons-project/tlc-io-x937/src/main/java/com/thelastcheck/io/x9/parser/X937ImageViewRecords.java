...
public interface X937ImageViewRecords {

    X937ImageViewDetailRecord imageViewDetailRecord();

    X937ImageViewDataRecord imageViewDataRecord();

    X937ImageViewAnalysisRecord imageViewAnalysisRecord();
}
